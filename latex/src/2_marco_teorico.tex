...
\subsection{Conceptos metodológicos}

\subsubsection{N-gramas}
Secuencias contiguas de \(n\) tokens (palabras) que capturan patrones léxicos y expresiones idiomáticas en las letras de canciones. Este concepto se expone a detalle en la sección de Representación vectorial del Marco Teórico.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/02_n-gramas.png}
  \caption{Ejemplo de n-gramas: unigrama, bigrama y trigrama en la frase “This is a sentence”.}
  \label{fig:ngramas}
\end{figure}

\subsection{Lematización y su Importancia en Letras de Canciones}

La lematización consiste en reducir una palabra a su forma base o lema, considerando su categoría gramatical y contexto. A diferencia del stemming, que simplemente recorta palabras, la lematización aplica reglas lingüísticas para mantener el significado. En el contexto musical, esta técnica permite unificar variantes verbales y estilísticas frecuentes en letras de canciones, mejorando así la calidad del análisis semántico y la eficiencia de los modelos de clasificación \parencite{Jurafsky2021}.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/02_lematizacion_diagrama.png}
	\caption{Lematización: variantes del verbo “cantar”}
	\label{fig:lematizacion_diagrama}
\end{figure}
